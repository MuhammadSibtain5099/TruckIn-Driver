...
public class MapTrackingFragment extends Fragment implements OnMapReadyCallback, TaskLoadedCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_map_tracking, container, false);
